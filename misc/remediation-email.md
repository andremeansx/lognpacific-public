...
1. [**Third-Party Software Removal (Wireshark)**](https://github.com/andremeansx/vulnerability-management-program/blob/main/remediation-wireshark-uninstall.ps1)
...
**Andre Means, Security Analyst**<br/>
